...
<br /><br /><br /><br />
    <button id="browsereports" class="btn btn-primary btn-lg">
        Browse Reports...
    </button>
</div>	
...
$(document).ready(function() {
  ...
  $('#user').popover();
  $('#reportslist tr').show();
    $('#browsereports').click(function() {
        $.facebox.loading();
        $.ajax({
            type:'POST',
            url:path_prefix+'reports/reportslistpopup',
            data:
            {
            ...
            <link href="<?php echo base_url()?>assets/js/facebox/facebox.css" rel="stylesheet" media="screen">
            <script src="<?php echo base_url()?>assets/js/facebox/facebox.js"></script>
  </body>
</html>