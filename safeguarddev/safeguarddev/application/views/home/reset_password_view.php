...
echo form_open('forgotpassword/reset_password');
$username=array(
    'name'=>'username',
    'id' =>'username',
    'value'=>'',
...
-->
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12">
                        <?php echo (isset($user_error))?$user_error:''; ?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12">
					    <?php echo form_submit(array('name'=>'reset_password' ,'class'=>'btn btn-success btn-block userani2'),'Reset Password');?>
                ...
                <div class="form-group" style="color:wheat; font-weight:normal; font-family:flat;">
                    ...
                    <div class="col-xs-6">
                     ...
                     <!--   <label><a href="login/reset_password" style="color:white;text-decoration:none;">Forgot Password?</a></label>
