<div class="row" style="background-color: #1063B8;">
    ...
    <div class="col-lg-1">
        <img src="<?=base_url();?>assets/images/logo.png" style="padding-top:7px;">
    </div>
        ...
        <nav class="navbar navbar" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                ...
                <ul  class="nav navbar-nav nav-pills   pull-right text-center topnav">
                    <li class="<?php echo ($this->router->fetch_class()=='users')?'active':'' ?>"><a href="<?php echo site_url('/users'); ?>"><i class="icon-home "></i> <br> Home</a></li>
