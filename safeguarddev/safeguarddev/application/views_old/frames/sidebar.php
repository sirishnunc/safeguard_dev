<div class="row-offcanvas row-offcanvas-left">
    ...
    <div class="col-xs-2 sidebar-offcanvas" id="sidebar" role="navigation">
        <div class="list-group left_menu" >
            ...
            <a href="<?php echo site_url('/reports'); ?>" class="list-group-item"> <i class="icon-dashboard"></i><p>Dashboard</p></a>
            <a href="<?php echo site_url('/reports'); ?>" class="list-group-item"><i class="icon-list-alt"></i><p>SSRS Reports</p></a>
            <a href="<?php echo site_url('/reports'); ?>" class="list-group-item"><i class="icon-search"></i><p>Tableau Reports</p></a>
